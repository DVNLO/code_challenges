...
//Fatal flaw in the composition of this program.
/* A vector of strings is composted of rows of strings and columns of characters.
Redesign the program to account for this difference. 
*/
